...
[Example of the image](https://nextjs13-mvp.vercel.app/api/user-image?id=1)

[Open Graph meta tags preview](https://www.opengraph.xyz/url/https%3A%2F%2Fnextjs13-mvp.vercel.app%2Fparallel%2Fusers%2F1)
...
export async function GET(request: Request) {
  ...
  return new ImageResponse(
    (
      ...
      >
        <span style={{ fontFamily: 'Righteous' }}>{user.name}</span>
